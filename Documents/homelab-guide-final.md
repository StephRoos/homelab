---
title: "Homelab — Guide d'installation complet"
tags: [homelab, guide, infrastructure, serveur]
---

# Homelab — Guide d'installation complet
...
# Appuyer Entrée 3 fois (pas de passphrase)
...
## 04 - Outils système & sudo
*Depuis le Mac uniquement · SSH headless*
Sudo pour admin · Vérifications post-déplacement · Prêt pour la suite
...
> **Resultat** : 🏠
 Homelab production-ready. Stack souveraine complète. Sécurité électrique assurée. Un seul câble USB-C pour tout gérer depuis le bureau.
